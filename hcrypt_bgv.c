...
void vec_tensor(fmpz_poly_mat_t tensor, fmpz_poly_mat_t x)
{
        long row1 = fmpz_poly_mat_nrows(x), row2;
        row2 = row1 * row1;
...
void e_skeygen(fmpz_poly_mat_t sk, param_node_t *param)
{
        fmpz_poly_mat_init(sk, 1 + param->n , 1);
